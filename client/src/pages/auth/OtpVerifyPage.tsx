...
export default function OtpVerifyPage() {
	...
	const handleResendOtp = async () => {
		...
		try {
			const res = (await resendOtp({ email: normalizedEmail }).unwrap()) as ApiMessageResponse
					...
					<div className="w-full max-w-[420px] lg:pt-14">
						...
						<div className="mt-6 flex items-center justify-between">
							...
							<button
								...
								className="text-[0.75rem] uppercase tracking-[0.2em] text-[#8f2a22] underline disabled:cursor-not-allowed disabled:opacity-60"
							>
